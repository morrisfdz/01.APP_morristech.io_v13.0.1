...
<body>
        ...
        <nav class="nav container">
            ...
            <div class="nav_menu" id="nav-menu">
                <ul class="nav_list grid">
                    ...
                    - Proyectos                  100%
                    - Equipo                     100%
                    - Formulario contacto        30%
                    -->


                    <li class="nav_item">
                        <a href="#Principal" class="nav_link active-link">
                            <i class="uil uil-estate nav_icon"></i> Principal
                        </a>
                    </li>
                    <li class="nav_item">
                        <a href="#Conocenos" class="nav_link">
                    ...
                    <li class="nav_item">
                        <a href="#Contactanos" class="nav_link">
    ...
    <main class="main">
        ...
        <section class="testimonial section ">
            ...
            <span class="section_subtitle">¿Qué dicen nuestros clientes?</span>
            <div class="testimonial_container container swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="testimonial_content swiper-slide">
                        <div class="testimonial_data">
                            <div class="testimonial_header">
                                <img src="https://dev.dakidarts.com/wixa/assets/img/testimonial1.jpg" alt=""
                                    class="testimonial_img">
                                <div>
                                    <h3 class="testimonial_name">Michel Parker</h3>
                                    <span class="testimonial_client">Cliente</span>
                                </div>
                            </div>
                            <div>
                        ...
                        <p class="testimonial_description">
                            Obtuve una buena impresión.
                            Logre recibir toda la calidad posible,
                            atención y soporte 24 horas.
                        </p>
                    </div>
                    ...
                    <div class="testimonial_content swiper-slide">
                        <div class="testimonial_data">
                            <div class="testimonial_header">
                                <img src="https://dev.dakidarts.com/wixa/assets/img/testimonial2.jpg" alt=""
                                    class="testimonial_img">
                                <div>
                                    <h3 class="testimonial_name">Eric Alfredo</h3>
                                    <span class="testimonial_client">Cliente</span>
                                </div>
                        ...
                        <p class="testimonial_description">Mi proyecto quedó maravilloso. Encantado.</p>
                    </div>
                    ...
                    <div class="testimonial_content swiper-slide">
                        <div class="testimonial_data">
                            <div class="testimonial_header">
                                <img src="https://dev.dakidarts.com/wixa/assets/img/testimonial3.jpg" alt=""
                                    class="testimonial_img">
                                <div>
                                    <h3 class="testimonial_name">Orlando Smith</h3>
                                    <span class="testimonial_client">Ex Administrador</span>
                                </div>
                            </div>
                            <div>
                                <i class="uil uil-star testimonial_icon-star"></i>
                        ...
                        <p class="testimonial_description">Me encantó trabajar en MorrisTech, una experiencia de
                            crecimiento magnífica.
        ...
        <section class="contact section " id="Contactanos">
            ...
            <div class="contact_container container grid">
                ...
                <form action="index.php" method="post" class="contact_form grid">
    ...
    <!--==================== LECTURA DE BD DE CONTACTOS ====================-->
    <h2 class="section_title">Informacion de formulario de contacto</h2>
    <div class="contact_container container grid">
